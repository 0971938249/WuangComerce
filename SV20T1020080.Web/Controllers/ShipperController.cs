...
namespace SV20T1020080.Web.Controllers
{
    ...
    public class ShipperController : Controller
    {
        ...
        private const string SHIPPPER_SEARCH = "shipper_search";//Tên biến dùng để luu trong session
        public IActionResult Index()
        {
            // lấy đầu vào tìm kiếm hiện đang lưu lại trong sesion
            PaginationSearchInput input = ApplicationContext.GetSessionData<PaginationSearchInput>(SHIPPPER_SEARCH);
        ...
        public IActionResult Search(PaginationSearchInput input)
        {
            ...
            ApplicationContext.SetSessionData(SHIPPPER_SEARCH, input);
            return View(model);
        }
